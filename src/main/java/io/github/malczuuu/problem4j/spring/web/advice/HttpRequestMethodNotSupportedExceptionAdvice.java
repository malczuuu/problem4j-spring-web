...
public class HttpRequestMethodNotSupportedExceptionAdvice
    extends AbstractAdvice<HttpRequestMethodNotSupportedException> {

  public HttpRequestMethodNotSupportedExceptionAdvice(List<ExceptionAdapter> exceptionAdapters) {
