...
public class MethodValidationExceptionAdvice extends AbstractAdvice<MethodValidationException> {

  private final FieldNameFormatting fieldNameFormatting;

  public MethodValidationExceptionAdvice(
  ...
  @Override
  public ResponseEntity<Problem> handle(MethodValidationException ex, WebRequest request) {
